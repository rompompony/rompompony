## <div align="center">Привет, меня зовут Роман!</div>
...
### Обо мне 
Я QA Engineer. Уже имею коммерческий опыт ручного тестирования iOS приложений. В свободне время осваиваю Python для автоматизации.
<br>Здесь я поделюсь с вами тестовыми артефактами, которые мне удалось создать ещё в процессе самостоятельного обучения.
